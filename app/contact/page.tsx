...
export default function ContactPage() {
  return (
    <main
      className={`min-h-screen bg-[#ffe9ef] -z-20 relative flex flex-col text-theme-grey-5 ${saira.className}`}
    >
      <Shapes />
      <Header activeTab="/contact" />
      <div className="flex justify-center px-8 md:px-12 flex-1 items-center">
        <div className="pb-12 pt-8 w-full grid grid-cols-[auto_auto] md:grid-cols-[20rem_auto] grid-rows-[auto_1fr] max-w-[800px] gap-4 h-min">
            ...
            <div className="w-full flex flex-col gap-6 justify-center items-center px-8 max-md:px-6 max-md:max-w-[36rem]">
              ...
              <div className="flex gap-4">
                <Button
                  asChild
                  variant="outline"
                  className="text-2xl rounded-full p-0 w-[44px] h-[44px] !bg-transparent !text-theme-grey5 border-2 border-solid border-theme-grey-5 transition-all duration-200"
                >
              ...
              <div className="max-sm:text-center grid grid-cols-[auto_1fr] text-xl w-full gap-2 items-center max-md:w-fit max-md:mt-4">
                ...
                <span className="text-[1.025rem] max-sm:text-base max-sm:col-span-2">
                  feitocomamor@gmail.com
                </span>
